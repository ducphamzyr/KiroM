// Package logger provides a lightweight leveled logger for KiroM.
//
...
func Debugf(format string, v ...interface{}) {
	if enabled(LevelDebug) {
		...
		logBuffer.add("debug", sprintf(format, v...))
	}
}
...
func Infof(format string, v ...interface{}) {
	if enabled(LevelInfo) {
		...
		logBuffer.add("info", sprintf(format, v...))
	}
}
...
func Warnf(format string, v ...interface{}) {
	if enabled(LevelWarn) {
		...
		logBuffer.add("warn", sprintf(format, v...))
	}
}
...
func Errorf(format string, v ...interface{}) {
	if enabled(LevelError) {
		...
		logBuffer.add("error", sprintf(format, v...))
	}
}

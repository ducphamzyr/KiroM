...
// BuilderIdSession Phiên đăng nhập Builder ID
...
// StartBuilderIdLogin Bắt đầu đăng nhập Builder ID
func StartBuilderIdLogin(region string) (*BuilderIdSession, error) {
	...
	// Step 2: Khởi tạo device authorization
	...
	// Dọn các phiên hết hạn
	go cleanupExpiredBuilderIdSessions()

	return session, nil
}

// PollBuilderIdAuth Polling trạng thái Builder ID authorization
...
// GetBuilderIdSession Lấy thông tin phiên
...
// cleanupExpiredBuilderIdSessions Dọn các phiên hết hạn

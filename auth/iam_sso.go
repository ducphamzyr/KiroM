...
// StartIamSsoLogin Khởi tạo đăng nhập IAM SSO
...
// CompleteIamSsoLogin Hoàn tất đăng nhập IAM SSO
func CompleteIamSsoLogin(sessionID, callbackUrl string) (accessToken, refreshToken, clientID, clientSecret, region string, expiresIn int, err error) {
	...
	if code == "" {
		return "", "", "", "", "", 0, fmt.Errorf("authorization code not received")
	}
